...
export default function Sidebar({
  ...
  return (
    <aside className="hidden md:flex flex-col w-60 fixed inset-y-0 left-0 bg-[#0d1426] border-r border-slate-800/60 z-50">
      {/* Brand */}
      <div className="flex items-center gap-3 px-6 py-6 border-b border-slate-800/60">
        ...
        <div>
          ...
          <p className="text-[9px] text-slate-400 tracking-widest uppercase font-medium">Smart Analyzer</p>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto py-6 px-4 space-y-8 custom-scrollbar">
        {/* Monitor Section */}
        <div>
          <h3 className="px-2 text-xs font-semibold tracking-widest text-slate-500 uppercase mb-3">Monitor</h3>
        ...
        {/* Data Source Section */}
        <div>
          <h3 className="px-2 text-xs font-semibold tracking-widest text-slate-500 uppercase mb-3">Data Source</h3>
          <div className="space-y-1">
            <button
